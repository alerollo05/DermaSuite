...
data class ParameterDistrictState(
    @get:PropertyName("ARMS") @set:PropertyName("ARMS") var arms: DistrictState = DistrictState(),
    @get:PropertyName("HEAD") @set:PropertyName("HEAD") var head: DistrictState = DistrictState(),
    @get:PropertyName("LEGS") @set:PropertyName("LEGS") var legs: DistrictState = DistrictState(),
    @get:PropertyName("TRUNK") @set:PropertyName("TRUNK") var trunk: DistrictState = DistrictState()
)
